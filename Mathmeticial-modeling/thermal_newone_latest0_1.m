function [] = thermal_newone_latest0_1(dt, ratio)
%read me: ratio should smaller than 1;
...
for i = 1:length(t)
    ...
    if mod(int32(i),int32(10^5))==0
        tempMatrix = [tempMatrix; zeros(1,n); T(1:n)];
    end
    
    if mod(int32(i),int32(10^6))==0
        fileName = [num2str(t(i)),'sFile.mat'];
        save([num2str(ratio), '\\', fileName], 'tempMatrix','dT_dt');
    end    
...
save([num2str(ratio), '\\answer.mat'], 'tempMatrix','dT_dt');
disp("end");
